...
It is also possible to use [instruction decoders](instruction-decoders.md), which does not require writing your own custom translator. Or the simpler variant [mapping translators](mapping.md)
